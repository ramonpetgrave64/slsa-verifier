...
func GHAVerifierNew() *GHAVerifier {
	return &GHAVerifier{
		Logger: log.New(os.Stderr, "GHAVerifier: ", log.LstdFlags),
	}
}

// // ApplyOptions applies the VerifierOption to the verifier.
// func (v *GHAVerifier) ApplyOptions(options ...register.VerifierOption) error {
...
func (v *GHAVerifier) VerifyNpmPackage(ctx context.Context,
	...
	npm, err := NpmNew(ctx, trustedRoot, attestations, v.Logger, v.SigstoreTUFClient)
	if err != nil {
		return nil, nil, err
	}
	// err = npm.ApplyOptions(verifierOpts...)
	// if err != nil {
	// 	return nil, nil, err
	// }
